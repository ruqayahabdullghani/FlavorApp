...
function Recipes() {
  ...
  <>
    ...
    <div className='flex w-full items-center justify-center py-10'>
      <Button
    title="Show More"
    containerStyle="bg-green-800 text-white px-3 py-1 rounded-full text-sm hover:bg-green-900"
    handleClick={showMore}/>
</div>
  </>
) : (
  <>
    <div className='text-white w-full text-center justify-center py-10'>
      <p>No Recipe Found</p>
    </div>
  </>
)}
